<?php
$pageTitle = "Reporte de Días Recibidos";
$relativePath = "../";
...
$query = "SELECT dt.id, dt.fecha, dt.tipo, dt.monto, dt.combustible, dt.observaciones, dt.estado_entrega,
          ...
          WHERE dt.estado_entrega = 'Recibido'
          AND dt.fecha BETWEEN ? AND ?";
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item active" href="<?php echo $baseUrl; ?>reportes/dias_recibidos.php">Días recibidos</a></li>
...
<div class="container mt-4">
    ...
    <div class="card mb-4 no-print">
        ...
        <div class="card-body">
            <form method="get" action="dias_recibidos.php">
                <div class="row">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card border-success">
                        <div class="card-body text-center">
                            ...
                            <h3 class="card-text">$<?php echo number_format($totalRecibido, 2); ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card border-info">
                        <div class="card-body text-center">
                            ...
                            <h3 class="card-text">$<?php echo count($dias) > 0 ? number_format($totalRecibido / count($dias), 2) : '0.00'; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
