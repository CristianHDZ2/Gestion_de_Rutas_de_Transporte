...
// Procesar la eliminación de vehículo
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    $id = $_GET['delete'];
    
    // Verificar si hay rutas asociadas a este vehículo
    $checkQuery = "SELECT COUNT(*) as count FROM rutas WHERE vehiculo_id = ?";
    ...
    if ($checkRow['count'] > 0) {
        ...
        $queryInactivar = "UPDATE vehiculos SET estado = 'Inactivo' WHERE id = ?";
        ...
        if (mysqli_stmt_execute($stmtInactivar)) {
            showAlert("El vehículo ha sido inactivado correctamente ya que tiene rutas asociadas", "warning");
        } else {
            showAlert("Error al inactivar el vehículo: " . mysqli_error($conn), "danger");
        }
    } else {
        // Si no hay rutas asociadas, eliminar
        $queryEliminar = "DELETE FROM vehiculos WHERE id = ?";
        ...
        if (mysqli_stmt_execute($stmtEliminar)) {
            showAlert("El vehículo ha sido eliminado correctamente", "success");
        } else {
            showAlert("Error al eliminar el vehículo: " . mysqli_error($conn), "danger");
        }
    }
}
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item active" href="<?php echo $baseUrl; ?>vehiculos/lista_vehiculos.php">Lista de vehículos</a></li>
...
<div class="container mt-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="bi bi-truck"></i> Lista de Vehículos</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="searchTable" class="form-control" placeholder="Buscar vehículo...">
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    <a href="editar_vehiculo.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" title="Editar">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <a href="lista_vehiculos.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger btn-delete" data-bs-toggle="tooltip" title="Eliminar">
